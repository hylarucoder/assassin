...
from .graphql import WGraphQLView
from flask_resql.apps.user.view import Schema
...
bp.add_url_rule(
    "/graphql",
    view_func=WGraphQLView.as_view(
        "graphql", schema=Schema, graphiql=True, middleware=[]
    ),
)
